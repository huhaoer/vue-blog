<template>
  <div class="blog-toc-container">
    <h2>目录</h2>
    <RightList :list="tocWithSelect" @onSelect="handleSelect" />
  </div>
</template>
...
export default {
  ...
  created() {
    this.setSelectDebounce = debounce.call(this, this.setSelect, 50);
  ...
  methods: {
    handleSelect(item) {
      this.activeAnchor = item.anchor; // 先假设自己是激活的，然后继续看后面
